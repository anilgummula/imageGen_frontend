...
const Header = () => {
    ...
    // )
    return (
        <div className='text-center min-h-screen justify-center m-auto mt-48'>
     ...
     */}
            <button className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2 rounded-full hover:scale-[1.01] transition-all border border-white' onClick={onClickHandler}>
                Generate Images
            </button>
